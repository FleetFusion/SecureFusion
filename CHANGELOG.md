...
### Added
- Public verifier SPA at `verify.fleetfusion.app` — Angular standalone, browser-only, drag-drop or file picker, three-tier result (Hash on XRPL / Signed by platform key / Bitcoin-attested).
